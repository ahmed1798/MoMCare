...
class MoreDrVC: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.myDetailsBu.set(image: UIImage(named: "book (2)"), title: "My Details", titlePosition: .bottom, additionalSpacing: -5.0, state: .normal, color: #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1))
        self.moreBu.set(image: UIImage(named: "book (2)"), title: "The More", titlePosition: .bottom, additionalSpacing: -5.0, state: .normal, color: #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1))
